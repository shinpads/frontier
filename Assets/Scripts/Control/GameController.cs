...
public class GameController : MonoBehaviour {
	...
	//new Vector3(-6.7f, 5f, -88.76f)
	private Vector3[] teamSpawns =  { new Vector3(1000f, 500, 300f), new Vector3(-132.7f, 5f, 14.9f), new Vector3(-8.7f, 5f, 129.4f), new Vector3(104.4f, 3f, 15f) };
